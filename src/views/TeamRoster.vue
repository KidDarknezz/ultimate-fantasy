<template>
    <b-container>
        ...
        <b-row class="content" v-for="roster in teamRoster" :key="roster">
            <b-col cols="3">
                <p style="margin-bottom: 0">
                    {{ roster.originTeam | assignTeam }}
                </p>
            </b-col>
            <b-col cols="6">
...
export default {
    ...
    methods: {
        getTeam: function() {
            this.$http
                .get(
                    `https://ultimate-fantasy-fe04f.firebaseio.com/users/${this.$route.params.id}.json`
                )
                .then(response => {
